...
$(document).ready(typeaheadInitialize());
        ...
        @endif
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    {!! Form::open(['route' => ['recipes.update', $recipe->id],'files' => true, 'id' => 'recipeForm']) !!}
                        {{ csrf_field() }}
                        {{ method_field('PUT') }}
                        <div class="row">
                            <div class="col-md-7">
                                        ...
                                        <div class="row ingredientItem">
                                            <div class="form-group row">
                                                <div class="col-xs-2 col-xs-offset-1">
                                                    <input type="text" class="form-control quantityInput" value="{{ $ingredient->quantity }}">
                                                </div>
                                                <div class="col-xs-3">
                                                ...
                                                <div class="col-xs-3">
                                                    <input type="text" class="form-control preparationInput" value="{{ $ingredient->preparation }}"/>
                                                </div>
                                                <div class="col-xs-2">
                                                    <input type="text" class="form-control ingredientInput typeahead" value="{{ $ingredient->ingredient->name }}"/>
                                                </div>
                                            </div>
